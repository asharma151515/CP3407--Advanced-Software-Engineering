...
const transporter = nodemailer.createTransport({
  host: 'smtp.mailgun.org', // e.g., smtp.gmail.com or your SMTP provider
  port: 587, // or 465 for secure
  secure: false, // true for port 465, false for others
  auth: {
    user: 'cleaners@sandbox640587904cc2409d82f849555fe54fb4.mailgun.org', // your SMTP user
    pass: '100@Aryan',    // your SMTP password or app password
  },
});
